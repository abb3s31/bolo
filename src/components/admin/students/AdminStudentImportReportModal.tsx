...
// 📊 مكون نافذة تقرير نتائج استيراد ملفات الإكسل للطلاب (المقبول والمكرر والمرفوض)
...
// 📋 واجهة تقرير استيراد الطلاب
export interface StudentImportSummaryReport {
  totalRows: number;
...
// 📋 واجهة خصائص مودال تقرير استيراد إكسل الطلاب
export interface AdminStudentImportReportModalProps {
  importReport: StudentImportSummaryReport | null; // 📊 كائن تقرير نتائج الاستيراد
  setImportReport: (report: StudentImportSummaryReport | null) => void; // 🔄 دالة إغلاق وتصفير التقرير
...
// 🏛️ مكون عرض تقرير استيراد الإكسل التفصيلي للطلاب
export const AdminStudentImportReportModal: React.FC<AdminStudentImportReportModalProps> = ({
  importReport,
  setImportReport,
  activeReportTab,
  setActiveReportTab,
